...
VEHICLES_DATA_LIST = []
vehicles_id = []
REGION_SPEED = [(410,94), (1550,94),(1700,316),(200,316)]
...
class BasicSynchronousClient(object):
    ...
    def setup_camera(self):
        ...
        #camera_transform = carla.Transform(carla.Location(x=-20, y=27, z=5.5), carla.Rotation(pitch=-45,  yaw=0, roll=0.000000)) #pattern
        #camera_transform = carla.Transform(carla.Location(x=-55, y=68, z=9.5), carla.Rotation(pitch=0,  yaw=0, roll=0.000000))
        camera_transform = carla.Transform(carla.Location(x=50, y=40, z=10.5), carla.Rotation(pitch=-22,  yaw=-138, roll=0.000000))
